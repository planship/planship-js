...
export interface ListProductEntitlementsForCustomerRequest {
    productSlug: string;
    customerId: string;
}
...
export class EntitlementsApi extends runtime.BaseAPI {
    ...
    async listProductEntitlementsForCustomerRaw(requestParameters: ListProductEntitlementsForCustomerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.productSlug === null || requestParameters.productSlug === undefined) {
            throw new runtime.RequiredError('productSlug','Required parameter requestParameters.productSlug was null or undefined when calling listProductEntitlementsForCustomer.');
        }

        if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
            throw new runtime.RequiredError('customerId','Required parameter requestParameters.customerId was null or undefined when calling listProductEntitlementsForCustomer.');
        }
    ...
    async listProductEntitlementsForCustomer(requestParameters: ListProductEntitlementsForCustomerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.listProductEntitlementsForCustomerRaw(requestParameters, initOverrides);
