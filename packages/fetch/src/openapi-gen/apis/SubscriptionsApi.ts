...
export interface DeletePlanSubscriptionRequest {
    customerId: string;
...
export class SubscriptionsApi extends runtime.BaseAPI {
     ...
     */
    async deletePlanSubscriptionRaw(requestParameters: DeletePlanSubscriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubscriptionInDbBase>> {
        if (requestParameters.customerId === null || requestParameters.customerId === undefined) {
            throw new runtime.RequiredError('customerId','Required parameter requestParameters.customerId was null or undefined when calling deletePlanSubscription.');
        }

        if (requestParameters.subscriptionId === null || requestParameters.subscriptionId === undefined) {
            throw new runtime.RequiredError('subscriptionId','Required parameter requestParameters.subscriptionId was null or undefined when calling deletePlanSubscription.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SubscriptionInDbBaseFromJSON(jsonValue));
    }

    /**
     * Delete Plan Subscription
     */
    async deletePlanSubscription(requestParameters: DeletePlanSubscriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubscriptionInDbBase> {
        const response = await this.deletePlanSubscriptionRaw(requestParameters, initOverrides);
        return await response.value();
    }
