...
- [CustomerId](interfaces/CustomerId.md)
...
- [SubscriptionInDbBase](interfaces/SubscriptionInDbBase.md)
...
### instanceOfCustomerId

▸ **instanceOfCustomerId**(`value`): `boolean`
...
### instanceOfSubscriptionCustomerCreate

▸ **instanceOfSubscriptionCustomerCreate**(`value`): `boolean`
...
### instanceOfSubscriptionInDbBase

▸ **instanceOfSubscriptionInDbBase**(`value`): `boolean`
