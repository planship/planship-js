...
import {
    ...
    SubscriptionCustomerCreateFromJSON,
    SubscriptionCustomerCreateToJSON,
...
export class SubscriptionCustomersApi extends runtime.BaseAPI {
    ...
    async addCustomerToSubscriptionRaw(requestParameters: AddCustomerToSubscriptionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubscriptionCustomer>> {
        ...
        if (requestParameters.subscriptionCustomerCreate === null || requestParameters.subscriptionCustomerCreate === undefined) {
            throw new runtime.RequiredError('subscriptionCustomerCreate','Required parameter requestParameters.subscriptionCustomerCreate was null or undefined when calling addCustomerToSubscription.');
        }
        ...
        const response = await this.request({
            ...
            body: SubscriptionCustomerCreateToJSON(requestParameters.subscriptionCustomerCreate),
        }, initOverrides);
