...
export const ProductsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getProductPlan: async (productSlug: string, slug: string, orderBy?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'productSlug' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listProductLevers: async (slug: string, orderBy?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'slug' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listProductPlanEntitlements: async (productSlug: string, slug: string, orderBy?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'productSlug' is not null or undefined
...
export const ProductsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getProductPlan(productSlug: string, slug: string, orderBy?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Plan>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProductPlan(productSlug, slug, orderBy, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List all levers for the product with a given slug in the current organization. Organization is determined by the Planship API auth token.
         ...
         * @throws {RequiredError}
         */
        async listProductLevers(slug: string, orderBy?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<LeverInList>>> {
         ...
         * @throws {RequiredError}
         */
        async listProductPlanEntitlements(productSlug: string, slug: string, orderBy?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PlanEntitlement>>> {
...
export const ProductsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getProductPlan(productSlug: string, slug: string, orderBy?: string, options?: any): AxiosPromise<Plan> {
            return localVarFp.getProductPlan(productSlug, slug, orderBy, options).then((request) => request(axios, basePath));
        },
        /**
         * List all levers for the product with a given slug in the current organization. Organization is determined by the Planship API auth token.
         * @summary List Product Levers
         ...
         * @throws {RequiredError}
         */
        listProductLevers(slug: string, orderBy?: string, options?: any): AxiosPromise<Array<LeverInList>> {
         ...
         * @throws {RequiredError}
         */
        listProductPlanEntitlements(productSlug: string, slug: string, orderBy?: string, options?: any): AxiosPromise<Array<PlanEntitlement>> {
...
export class ProductsApi extends BaseAPI {
     ...
     * @memberof ProductsApi
     */
    public getProductPlan(productSlug: string, slug: string, orderBy?: string, options?: AxiosRequestConfig) {
        return ProductsApiFp(this.configuration).getProductPlan(productSlug, slug, orderBy, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProductsApi
     */
    public listProductLevers(slug: string, orderBy?: string, options?: AxiosRequestConfig) {
     ...
     * @memberof ProductsApi
     */
    public listProductPlanEntitlements(productSlug: string, slug: string, orderBy?: string, options?: AxiosRequestConfig) {
