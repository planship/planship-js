...
// @ts-ignore
import { SubscriptionInDbBase } from '../models';
// @ts-ignore
...
export const SubscriptionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * 
         * @summary Delete Plan Subscription
         * @param {string} customerId 
         * @param {string} subscriptionId 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deletePlanSubscription: async (customerId: string, subscriptionId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'customerId' is not null or undefined
            assertParamExists('deletePlanSubscription', 'customerId', customerId)
            // verify required parameter 'subscriptionId' is not null or undefined
            assertParamExists('deletePlanSubscription', 'subscriptionId', subscriptionId)
         ...
         * @throws {RequiredError}
         */
        listCustomerPlanSubscriptions: async (customerId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'customerId' is not null or undefined
...
export const SubscriptionsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deletePlanSubscription(customerId: string, subscriptionId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SubscriptionInDbBase>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deletePlanSubscription(customerId, subscriptionId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async listCustomerPlanSubscriptions(customerId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CustomerSubscriptionWithPlan>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listCustomerPlanSubscriptions(customerId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const SubscriptionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deletePlanSubscription(customerId: string, subscriptionId: string, options?: any): AxiosPromise<SubscriptionInDbBase> {
            return localVarFp.deletePlanSubscription(customerId, subscriptionId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get Customer Plan Subscription
         ...
         * @throws {RequiredError}
         */
        listCustomerPlanSubscriptions(customerId: string, options?: any): AxiosPromise<Array<CustomerSubscriptionWithPlan>> {
            return localVarFp.listCustomerPlanSubscriptions(customerId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Modify Customer Plan Subscription
...
export class SubscriptionsApi extends BaseAPI {
    ...
    public createPlanSubscriptionForCustomer(customerId: string, subscriptionCreate: SubscriptionCreate, options?: AxiosRequestConfig) {
        return SubscriptionsApiFp(this.configuration).createPlanSubscriptionForCustomer(customerId, subscriptionCreate, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SubscriptionsApi
     */
    public deletePlanSubscription(customerId: string, subscriptionId: string, options?: AxiosRequestConfig) {
        return SubscriptionsApiFp(this.configuration).deletePlanSubscription(customerId, subscriptionId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getCustomerPlanSubscription(customerId: string, subscriptionId: string, options?: AxiosRequestConfig) {
        return SubscriptionsApiFp(this.configuration).getCustomerPlanSubscription(customerId, subscriptionId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SubscriptionsApi
     */
    public listCustomerPlanSubscriptions(customerId: string, options?: AxiosRequestConfig) {
        return SubscriptionsApiFp(this.configuration).listCustomerPlanSubscriptions(customerId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public modifyCustomerPlanSubscription(customerId: string, subscriptionId: string, subscriptionUpdateWithSlugs: SubscriptionUpdateWithSlugs, options?: AxiosRequestConfig) {
        return SubscriptionsApiFp(this.configuration).modifyCustomerPlanSubscription(customerId, subscriptionId, subscriptionUpdateWithSlugs, options).then((request) => request(this.axios, this.basePath));
    }
}
