...
// @ts-ignore
import { SubscriptionCustomerCreate } from '../models';
// @ts-ignore
...
export const SubscriptionCustomersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {SubscriptionCustomerCreate} subscriptionCustomerCreate 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        addCustomerToSubscription: async (customerId: string, subscriptionId: string, subscriptionCustomerCreate: SubscriptionCustomerCreate, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            // verify required parameter 'subscriptionCustomerCreate' is not null or undefined
            assertParamExists('addCustomerToSubscription', 'subscriptionCustomerCreate', subscriptionCustomerCreate)
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(subscriptionCustomerCreate, localVarRequestOptions, configuration)
...
export const SubscriptionCustomersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async addCustomerToSubscription(customerId: string, subscriptionId: string, subscriptionCustomerCreate: SubscriptionCustomerCreate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SubscriptionCustomer>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.addCustomerToSubscription(customerId, subscriptionId, subscriptionCustomerCreate, options);
...
export const SubscriptionCustomersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addCustomerToSubscription(customerId: string, subscriptionId: string, subscriptionCustomerCreate: SubscriptionCustomerCreate, options?: any): AxiosPromise<SubscriptionCustomer> {
            return localVarFp.addCustomerToSubscription(customerId, subscriptionId, subscriptionCustomerCreate, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary List Subscription Customers
...
export class SubscriptionCustomersApi extends BaseAPI {
     ...
     */
    public addCustomerToSubscription(customerId: string, subscriptionId: string, subscriptionCustomerCreate: SubscriptionCustomerCreate, options?: AxiosRequestConfig) {
        return SubscriptionCustomersApiFp(this.configuration).addCustomerToSubscription(customerId, subscriptionId, subscriptionCustomerCreate, options).then((request) => request(this.axios, this.basePath));
    }
